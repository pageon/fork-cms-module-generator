...
Feature: It is possible to generate basic crud actions for an entity
  Scenario: Generate an delete action
    ...
    And the file "src/Backend/Modules/TestModule/Actions/MyTestEntityDelete.php" should be dumped and look like "../generate/backend/resources/php71/Backend/Modules/TestModule/Actions/MyTestEntityDelete.php"
