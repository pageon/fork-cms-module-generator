...
final class DeleteCommandHandler extends GeneratableClass
{
    /** @var ClassName */
    private $className;
    ...
    public static function fromDataTransferObject(CRUDCommandDataTransferObject $CRUDCommandDataTransferObject): self
    {
        ...
        return new self(
            new ClassName(
                'Delete' . $entityClassName->getRealName() . 'Handler',
                PhpNamespace::fromDataTransferObject($CRUDCommandDataTransferObject->commandNamespace)
            ),
            $entityClassName,
            new ClassName('Delete' . $entityClassName->getRealName(), $entityClassName->getNamespace()),
